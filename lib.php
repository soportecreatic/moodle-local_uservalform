...
/**
 * Extend course navigation adding 'Validation Form' that allows to access
 * navigation options.
 *
 * @param stdClass $navigation Navigation Menu object.
 * @param stdClass $course Course information object.
